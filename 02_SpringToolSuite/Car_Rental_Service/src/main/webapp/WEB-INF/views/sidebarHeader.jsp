...
<aside class="menu-sidebar d-none d-lg-block">
	<div class="logo">
		<a href=""> <img src="images/icon/logo.png" alt="SyneCab" />
		</a>
	</div>
...
<!-- 						<li><a href="index4.html">Dashboard 4</a></li> -->
<!-- 					</ul></li> -->
				<li><a href="login"> <i class="fas fa-tachometer-alt"></i>Home Page
				</a></li>
				<li class="active"><a href="success"> <i
	...
	<div class="section__content section__content--p30">
		<div class="container-fluid">
			<div class="header-wrap">
				<form class="form-header" action="searchDriver" method="POST">
					<input class="au-input au-input--xl" type="text" name="search"
						placeholder="Search Driver By City" />
