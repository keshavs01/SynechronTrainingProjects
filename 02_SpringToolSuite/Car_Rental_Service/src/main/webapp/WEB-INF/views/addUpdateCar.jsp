			...
			<div class="container-fluid">
				<div class="card">
					<div class="card-header">
						<strong>Alter Car</strong> Details
					</div>
					<div class="card-body card-block">
						<form:form action="addUpdateCar" method="post"
							enctype="multipart/form-data" class="form-horizontal">
							<div class="row form-group">
								<div class="col col-md-3">
									<label for="text-input" class=" form-control-label">Car
										ID</label>
								</div>
								<div class="col-12 col-md-9">
									<form:input path="carId" readonly="${isEdit}" type="number"
							...
							<div class="row form-group">
								...
								<div class="col-12 col-md-9">
									<form:input path="carName" type="text" placeholder="Text"
										class="form-control" />
							...
							<div class="row form-group">
								<div class="col col-md-3">
									<label for="select" class=" form-control-label">Car Catgory</label>
								</div>
								<div class="col-12 col-md-9">
									<form:select path="category" name="select" id="select"
 										class="form-control"> 
 										<c:forEach items="${category}" var="item">
 											<form:option value="${item}">${item.categoryName}</form:option>
										</c:forEach>
 									</form:select>
								</div>
							</div>
